            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li <?php echo ($page == 'manage-users' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'verification-requests' || $page == 'monetization-requests') ? 'class="active"' : ''; ?>>
                            <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <ul class="ml-menu">
                                ...
                                <li <?php echo ($page == 'monetization-requests') ? 'class="active"' : ''; ?>>
                        ...
                        <li <?php echo ($page == 'manage-video-reports' || $page == 'copy_report') ? 'class="active"' : ''; ?>>
                            <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <ul class="ml-menu">
                                ...
                                <li <?php echo ($page == 'copy_report') ? 'class="active"' : ''; ?>>
                                    <a href="<?php echo PT_LoadAdminLinkSettings('copy_report'); ?>">
                        ...
                        <?php if (PT_IsAdmin() == true) { ?>
                            <li <?php echo ($page == 'manage-updates') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-updates'); ?>">
