...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2020 at 05:59 AM
...
(1, 'theme', 'default'),
(2, 'censored_words', ''),
(3, 'title', 'Videos | Poppin'),
(4, 'name', 'Videos | Poppin'),
(5, 'keyword', 'playtube,video sharing'),
(6, 'email', 'bonani@maginvest.co.za'),
...
(34, 'total_dislikes', '0'),
(35, 'total_saved', '0'),
(36, 'last_admin_collection', '1577965381'),
...
(78, 'pub_price', '0.02'),
(79, 'usr_v_mon', 'on'),
(80, 'apps_api_id', 'bb6732db0c4f925a5d5aa21f10a665bf'),
(81, 'apps_api_key', '84841a64df6dbdbde35b0c8617ff652e'),
...
(542, 'rent_price', '', 'Rent Price (Leave empty for free videos)', 'سعر الإيجار (اتركه فارغًا لمقاطع الفيديو المجانية)', 'Huurprijs (laat leeg voor gratis video\'s)', 'Prix de location (Laissez vide pour les vidéos gratuites)', 'Mietpreis (für kostenlose Videos leer lassen)', 'Стоимость аренды (оставьте пустым для бесплатных видео)', 'Precio de renta (dejar vacio para videos gratis)', 'Kira Fiyatı (Ücretsiz videolar için boş bırakın)'),
...
(1, 'f6b9d88bdd6ad74e67e61547cd1d5359185905c215779653646a6e5cb0a5329f3e6abd91f180953490', 1, 'web', 'a:6:{s:9:\"userAgent\";s:77:\"Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0\";s:4:\"name\";s:15:\"Mozilla Firefox\";s:7:\"version\";s:4:\"71.0\";s:8:\"platform\";s:7:\"windows\";s:7:\"pattern\";s:67:\"#(?<browser>Version|Firefox|other)[/ ]+(?<version>[0-9.|a-zA-Z.]*)#\";s:10:\"ip_address\";s:3:\"::1\";}', 1577965364),
(2, '7beb6caaa61cfa75b89ff98b52d7fa7d6cd5eb661578026822a8e112419a68a5db172c45612e9e3450', 1, 'web', 'a:6:{s:9:\"userAgent\";s:77:\"Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0\";s:4:\"name\";s:15:\"Mozilla Firefox\";s:7:\"version\";s:4:\"71.0\";s:8:\"platform\";s:7:\"windows\";s:7:\"pattern\";s:67:\"#(?<browser>Version|Firefox|other)[/ ]+(?<version>[0-9.|a-zA-Z.]*)#\";s:10:\"ip_address\";s:3:\"::1\";}', 1578026822);
...
INSERT INTO `users` (`id`, `username`, `email`, `ip_address`, `password`, `first_name`, `last_name`, `gender`, `email_code`, `device_id`, `language`, `avatar`, `cover`, `src`, `country_id`, `age`, `about`, `google`, `facebook`, `twitter`, `instagram`, `active`, `admin`, `verified`, `last_active`, `registered`, `is_pro`, `imports`, `uploads`, `wallet`, `balance`, `video_mon`, `age_changed`, `donation_paypal_email`, `user_upload_limit`, `two_factor`, `last_month`, `active_time`, `active_expire`, `phone_number`, `address`, `city`, `state`, `zip`, `subscriber_price`, `monetization`, `new_email`) VALUES
(1, 'bonani', 'bonani@maginvest.co.za', '::1', '2fe77f273d30b2cc7ca3bd8a6479ae957573f90c', '', '', 'male', '', '', 'english', 'upload/photos/d-avatar.jpg', 'upload/photos/d-cover.jpg', '', 0, 0, NULL, '', '', '', '', 1, 1, 0, 1578026823, '00/0000', 0, 0, 0, '0', '0', 0, 0, '', '0', 0, NULL, 762, '1578095940', '', '', '', '', 0, '0', 0, '');
